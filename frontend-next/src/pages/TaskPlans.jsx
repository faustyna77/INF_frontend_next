...
const TaskPlans = () => {
  ...
  const fetchEmployees = async () => {
    try {
      ...
      const res = await fetch("https://springboot-backend-hnmc.onrender.com/users", {
        headers: {
  ...
  const fetchTasks = async () => {
    try {
      const token = localStorage.getItem("token");
      const res = await fetch("https://springboot-backend-hnmc.onrender.com/tasks", {
        headers: {
          "Authorization": `Bearer ${token}`,
  ...
  const fetchOrders = async () => {
    try {
      const token = localStorage.getItem("token");
      const response = await fetch("https://springboot-backend-hnmc.onrender.com/orders", {
        headers: {
          "Authorization": `Bearer ${token}`
        }
      });
  ...
  const handleAddTask = async () => {
    ...
    try {
        ...
        const completeTaskRes = await fetch(`https://springboot-backend-hnmc.onrender.com/tasks/${newTask.id}`, {
            headers: {
                "Authorization": `Bearer ${token}`,
                "Accept": "application/json"
            }
  ...
  const handleEditTask = async (taskId) => {
    ...
    try {
      ...
      const res = await fetch(`https://springboot-backend-hnmc.onrender.com/tasks/${taskId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`
  ...
  const generateReport = async () => {
    ...
    try {
      const response = await fetch("https://springboot-backend-hnmc.onrender.com/reports/tasks", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`
...
const filteredTasks = tasks.filter(task => {
 ...
 const handleSaveChanges = async () => {
  ...
  try {
    ...
    const res = await fetch(`https://springboot-backend-hnmc.onrender.com/tasks/${editingTask.id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`
