...
const Raports = () => {
  ...
  const fetchOrders = async () => {
    try {
      ...
      const res = await fetch("https://springboot-backend-hnmc.onrender.com/orders", {
        headers: {
  ...
  const generateOrderReport = async (orderId) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const response = await fetch(`https://springboot-backend-hnmc.onrender.com/reports/orders/${orderId}`, {
        method: "POST",
        headers: {
