...
const TaskWork = () => {
    ...
    const fetchTasks = async () => {
        try {
            ...
            const response = await fetch('https://springboot-backend-hnmc.onrender.com/tasks/assigned', {
                headers: {
    ...
    const handleStatusChange = async (taskId, newStatus) => {
        try {
            ...
            const response = await fetch(`https://springboot-backend-hnmc.onrender.com/tasks/${taskId}`, {
                method: 'PUT',
                headers: {
                    'Authorization': `Bearer ${token}`,
