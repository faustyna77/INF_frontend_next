...
const OrdersPanel = () => {
    ...
    const handleSaveChanges = async () => {
        try {
            ...
            const response = await fetch(`https://springboot-backend-hnmc.onrender.com/orders/${editingOrder.id}`, {
                method: 'PUT',
                headers: { 
            ...
            const updatedOrderResponse = await fetch(`https://springboot-backend-hnmc.onrender.com/orders/${editingOrder.id}`, {
